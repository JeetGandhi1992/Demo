...
//  Din Din Demo
//
//  Created by jeet_gandhi on 14/11/20.
//
...
extension UIViewController {
    ...
    public static func make<T: MenuViewControllerProtocol>(viewController: T.Type, viewModel: T.ViewModelT, from storyBoard: String = "Main") -> T where T: UIViewController {
